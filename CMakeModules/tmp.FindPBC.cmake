...
#        )
		...
		# Build the PBC submodule in-source.
                ...
                set( LIBPBC_PATH "${CMAKE_CURRENT_SOURCE_DIR}/../contrib/pbc" )
                set( PBC_DIR ${LIBPBC_PATH} )
                #set( PBC_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../contrib/pbc" )
                message( STATUS "PBC root is ${LIBPBC_PATH}" )
                message( STATUS "PBC_DIR is ${PBC_DIR}" )
        ExternalProject_Add( build_pbc
            ...
            #CONFIGURE_COMMAND ./setup && ./configure --prefix=${PROJECT_BINARY_DIR}/libraries/contrib/pbc
        ...
        set( PBC_LIBRARIES "${PBC_DIR}/.libs/libpbc.a" )
